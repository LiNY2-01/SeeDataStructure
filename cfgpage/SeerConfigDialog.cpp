...
SeerConfigDialog::SeerConfigDialog(QWidget* parent) : QDialog(parent) {
    ...
    configGdbButton->setIcon(QIcon(":/resources/gdb.png"));
    ...
    configEditorButton->setIcon(QIcon(":/resources/editor.png"));
    ...
    configSourceButton->setIcon(QIcon(":/resources/source.png"));
    ...
    configKeysButton->setIcon(QIcon(":/resources/keyboard-key.png"));
    ...
    configSeerButton->setIcon(QIcon(":/resources/seer_128x128.png"));
