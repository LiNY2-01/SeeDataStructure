...
//    QAction* createPrintpointAction;
    ...
    if (hasBreakpointLine(lineno) == true) {
        ...
        createBreakpointAction    = new QAction(QIcon(":/SeeDataStructure/resources/RelaxLightIcons/document-new.svg"), QString("Create breakpoint on line %1").arg(lineno), this);
//        createPrintpointAction    = new QAction(QIcon(":/SeeDataStructure/resources/RelaxLightIcons/document-new.svg"), QString("Create printpoint on line %1").arg(lineno), this);
        deleteAction              = new QAction(QIcon(":/SeeDataStructure/resources/RelaxLightIcons/edit-delete.svg"),  QString("Delete breakpoint %1 on line %2").arg(breakno).arg(lineno), this);
        enableAction              = new QAction(QIcon(":/SeeDataStructure/resources/RelaxLightIcons/list-add.svg"),     QString("Enable breakpoint %1 on line %2").arg(breakno).arg(lineno), this);
        disableAction             = new QAction(QIcon(":/SeeDataStructure/resources/RelaxLightIcons/list-remove.svg"),  QString("Disable breakpoint %1 on line %2").arg(breakno).arg(lineno), this);
...
//        createPrintpointAction->setEnabled(false);
        ...
        createBreakpointAction    = new QAction(QIcon(":/SeeDataStructure/resources/RelaxLightIcons/document-new.svg"), QString("Create breakpoint on line %1").arg(lineno), this);
//        createPrintpointAction    = new QAction(QIcon(":/SeeDataStructure/resources/RelaxLightIcons/document-new.svg"), QString("Create printpoint on line %1").arg(lineno), this);
        deleteAction              = new QAction(QIcon(":/SeeDataStructure/resources/RelaxLightIcons/edit-delete.svg"),  QString("Delete breakpoint on line %1").arg(lineno), this);
        enableAction              = new QAction(QIcon(":/SeeDataStructure/resources/RelaxLightIcons/list-add.svg"),     QString("Enable breakpoint on line %1").arg(lineno), this);
        disableAction             = new QAction(QIcon(":/SeeDataStructure/resources/RelaxLightIcons/list-remove.svg"),  QString("Disable breakpoint on line %1").arg(lineno), this);
        runToLineAction           = new QAction(QString("Run to line %1").arg(lineno), this);
